...
## Pour les standards
RUN apt-get install -y python-dev python-pip python-lxml python-relatorio python-genshi python-dateutil python-polib python-sql python-psycopg2 python-webdav python-pydot unoconv python-sphinx python-simplejson python-yaml git libgdal1h python-software-properties software-properties-common libpq-dev python-ldap python-gdal libgeos-dev python-vobject python-vatnumber apache2 make gfortran gcc g++ liblas-dev libgdal-dev libproj-dev liblapack-dev
